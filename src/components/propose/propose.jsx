//i18n => {"propose.propose.Text.1":"This project is in beta. Use at your own risk.","propose.propose.Text.2":"Back","propose.propose.Text.3":"Executor","propose.propose.Text.4":"IPFS Hash","propose.propose.Text.5":"Generate proposal"}
  ...
  render() {
  	...
  	return (
  		<div className={ classes.root }>
  			<Typography variant={'h5'} className={ classes.disaclaimer } id="propose.propose.Text.1" >{i18next.t('propose.propose.Text.1')}</Typography>
  			<div className={ classes.intro }>
  				...
  				>
  					<Typography variant={ 'h4'} id="propose.propose.Text.2" >{i18next.t('propose.propose.Text.2')}</Typography>
  				</Button>
  			</div>
            ...
            <div className={ classes.field }>
            	<div className={ classes.fieldTitle }>
            		<Typography variant='h4' id="propose.propose.Text.3" >{i18next.t('propose.propose.Text.3')}</Typography>
            	</div>
            	<TextField
            		fullWidth
            		disabled={ loading }
            ...
            <div className={ classes.field }>
            	<div className={ classes.fieldTitle }>
            		<Typography variant='h4' id="propose.propose.Text.4" >{i18next.t('propose.propose.Text.4')}</Typography>
            	</div>
            	<TextField
            		fullWidth
            		disabled={ loading }
            	...
            	/>
  				...
  				>
  					<Typography variant={ 'h4'} id="propose.propose.Text.5" >{i18next.t('propose.propose.Text.5')}</Typography>
  				</Button>
  			</div>
