//i18n => {"claim.claim.Text.1":"This project is in beta. Use at your own risk.","claim.claim.Text.2":"Wallet","claim.claim.Text.3":"Claim your rewards","claim.claim.Text.4":"Claim"}
  ...
  render() {
  	...
  	return (
  		<div className={ classes.root }>
  			<Typography variant={'h5'} className={ classes.disaclaimer } id="claim.claim.Text.1" >{i18next.t('claim.claim.Text.1')}</Typography>
  			<div className={ classes.intro }>
  				<Card className={ classes.addressContainer } onClick={this.overlayClicked}>
  					<Typography variant={ 'h3'} className={ classes.walletTitle } noWrap id="claim.claim.Text.2" >{i18next.t('claim.claim.Text.2')}</Typography>
  					<Typography variant={ 'h4'} className={ classes.walletAddress } noWrap>{ address }</Typography>
  					<div style={{ background: '#DC6BE5', opacity: '1', borderRadius: '10px', width: '10px', height: '10px', marginRight: '3px', marginTop:'3px', marginLeft:'6px' }}></div>
  				</Card>
  			</div>
  			<div className={ classes.claimContainer }>
  				<Typography className={ classes.stakeTitle } variant={ 'h3'} id="claim.claim.Text.3" >{i18next.t('claim.claim.Text.3')}</Typography>
  				...
  				<div className={ classes.stakeButtons }>
  					...
  					>
  						<Typography variant={ 'h4'} id="claim.claim.Text.4" >{i18next.t('claim.claim.Text.4')}</Typography>
  					</Button>
  				</div>
  			</div>
