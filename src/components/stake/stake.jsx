//i18n => {"stake.stake.Text.1":"This project is in beta. Use at your own risk.","stake.stake.Text.2":"Back","stake.stake.Text.3":"Your Balance","stake.stake.Text.4":"Currently Staked","stake.stake.Text.5":"Rewards Available","stake.stake.Text.6":"yCRV reward requirements","stake.stake.Text.7":"You must have voted in a proposal recently","stake.stake.Text.8":"You must have at least 1000 BPT staked in the Governance pool","stake.stake.Text.9":"Stake Tokens","stake.stake.Text.10":"Claim Rewards","stake.stake.Text.11":"Unstake Tokens","stake.stake.Text.12":"You need to have voted recently in order to claim rewards","stake.stake.Text.13":"You have recently voted, you can unstake at block {gov_voteLock}","stake.stake.Text.14":"Stake your tokens","stake.stake.Text.15":"Back","stake.stake.Text.16":"Stake","stake.stake.Text.17":"Unstake your tokens","stake.stake.Text.18":"Back","stake.stake.Text.19":"Unstake"}
...
class Stake extends Component {
  ...
  render() {
  	...
  	return (
  		<div className={ classes.root }>
  			<Typography variant={'h5'} className={ classes.disaclaimer } id="stake.stake.Text.1" >{i18next.t('stake.stake.Text.1')}</Typography>
  			<div className={ classes.intro }>
  				...
  				>
  					<Typography variant={ 'h4'} id="stake.stake.Text.2" >{i18next.t('stake.stake.Text.2')}</Typography>
  				</Button>
  			</div>
  			<div className={ classes.overview }>
  				<div className={ classes.overviewField }>
  					<Typography variant={ 'h3' } className={ classes.overviewTitle } id="stake.stake.Text.3" >{i18next.t('stake.stake.Text.3')}</Typography>
  				...
  				<div className={ classes.overviewField }>
  					<Typography variant={ 'h3' } className={ classes.overviewTitle } id="stake.stake.Text.4" >{i18next.t('stake.stake.Text.4')}</Typography>
  				...
  				<div className={ classes.overviewField }>
  					<Typography variant={ 'h3' } className={ classes.overviewTitle } id="stake.stake.Text.5" >{i18next.t('stake.stake.Text.5')}</Typography>
          ...
          <div className={ classes.actions }>
          	<Typography className={ classes.stakeTitle } variant={ 'h3'} id="stake.stake.Text.6" >{i18next.t('stake.stake.Text.6')}</Typography>
          	<div className={ classes.requirement }>
          		<Typography variant={'h4'} id="stake.stake.Text.7" >{i18next.t('stake.stake.Text.7')}</Typography><Typography variant={'h4'} className={ classes.check }>{ voteLockValid ? <CheckIcon style={{ color: colors.green }} /> : <ClearIcon style={{ color: colors.red }} /> }</Typography>
          	</div>
          	<div className={ classes.requirement }>
          		<Typography variant={'h4'} id="stake.stake.Text.8" >{i18next.t('stake.stake.Text.8')}</Typography><Typography variant={'h4'} className={ classes.check }>{ balanceValid ? <CheckIcon style={{ color: colors.green }} /> : <ClearIcon style={{ color: colors.red }} /> }</Typography>
          	</div>
          </div>
  			}
  	...
  	return (
  		<div className={ classes.actions }>
  			...
  			<div className={ classes.actionContainer}>
  				...
  				>
  					<Typography className={ classes.stakeButtonText } variant={ 'h4'} id="stake.stake.Text.9" >{i18next.t('stake.stake.Text.9')}</Typography>
  				</Button>
  			</div>
  			<div className={ classes.actionContainer}>
  				<Button
  				...
  				>
  					<Typography className={ classes.buttonText } variant={ 'h4'} id="stake.stake.Text.10" >{i18next.t('stake.stake.Text.10')}</Typography>
  				</Button>
  			</div>
  			<div className={ classes.actionContainer}>
  				<Button
  				...
  				>
  					<Typography className={ classes.buttonText } variant={ 'h4'} id="stake.stake.Text.11" >{i18next.t('stake.stake.Text.11')}</Typography>
  				</Button>
  			</div>
  			<div className={ classes.actionContainer}>
            ...
            >
  			...
  			{ (['GovernanceV2'].includes(pool.id) && !gov_voteLockValid  && !gov_breakerEnabled) && <Typography variant={'h4'} className={ classes.voteLockMessage } id="stake.stake.Text.12" >{i18next.t('stake.stake.Text.12')}</Typography> }
  			{ (['GovernanceV2'].includes(pool.id) && gov_voteLockValid) && <Typography variant={'h4'} className={ classes.voteLockMessage } id="stake.stake.Text.13" >{i18next.t('stake.stake.Text.13')} {gov_voteLock}</Typography> }
  		</div>
  	);
  }
  ...
  renderStake = () => {
  	...
  	return (
  		<div className={ classes.actions }>
  			<Typography className={ classes.stakeTitle } variant={ 'h3'} id="stake.stake.Text.14" >{i18next.t('stake.stake.Text.14')}</Typography>
  			...
  			<div className={ classes.stakeButtons }>
  				...
  				>
  					<Typography variant={ 'h4'} id="stake.stake.Text.15" >{i18next.t('stake.stake.Text.15')}</Typography>
  				</Button>
  				<Button
  					className={ classes.stakeButton }
  					variant="outlined"
  				...
  				>
  					<Typography variant={ 'h4'} id="stake.stake.Text.16" >{i18next.t('stake.stake.Text.16')}</Typography>
  				</Button>
  			</div>
  ...
  renderUnstake = () => {
  	...
  	return (
  		<div className={ classes.actions }>
  			<Typography className={ classes.stakeTitle } variant={ 'h3'} id="stake.stake.Text.17" >{i18next.t('stake.stake.Text.17')}</Typography>
  			...
  			<div className={ classes.stakeButtons }>
  				<Button
  					...
  					onClick={ () => { this.navigateInternal('options'); } }
  				>
  					<Typography variant={ 'h4'} id="stake.stake.Text.18" >{i18next.t('stake.stake.Text.18')}</Typography>
  				</Button>
  				<Button
  					className={ classes.stakeButton }
  					variant="outlined"
  				...
  				>
  					<Typography variant={ 'h4'} id="stake.stake.Text.19" >{i18next.t('stake.stake.Text.19')}</Typography>
  				</Button>
  			</div>
