//i18n => {"vote.vote.Text.1":"This project is in beta. Use at your own risk.","vote.vote.Text.2":"Go to Voting Dashboard","vote.vote.Text.3":"Done","vote.vote.Text.4":"Open","vote.vote.Text.5":"Register to vote","vote.vote.Text.6":"Generate a new proposal","vote.vote.Text.7":"No proposals","vote.vote.Text.8":"Vote Status","vote.vote.Text.9":"Proposer"}
  ...
  render() {
  	...
  	return (
  		<div className={ classes.root }>
  			<Typography variant={'h5'} className={ classes.disaclaimer } id="vote.vote.Text.1" >{i18next.t('vote.vote.Text.1')}</Typography>
  			<div className={ classes.dashboard }>
  				<div>
  					...
  					>
  						<Typography variant={ 'h4'} id="vote.vote.Text.2" >{i18next.t('vote.vote.Text.2')}</Typography>
  					</Button>
  				</div>
  			</div>
  			<div className={ classes.intro }>
  				<ToggleButtonGroup value={value} onChange={this.handleTabChange} aria-label="version" exclusive size={ 'small' }>
  					<ToggleButton value={0} aria-label="v1">
  						<Typography variant={ 'h4' } id="vote.vote.Text.3" >{i18next.t('vote.vote.Text.3')}</Typography>
  					</ToggleButton>
  					<ToggleButton value={1} aria-label="v2">
  						<Typography variant={ 'h4' } id="vote.vote.Text.4" >{i18next.t('vote.vote.Text.4')}</Typography>
  					</ToggleButton>
  				</ToggleButtonGroup>
              ...
              >
              	<Typography variant={ 'h4'} id="vote.vote.Text.5" >{i18next.t('vote.vote.Text.5')}</Typography>
              </Button>
  					}
              ...
              >
              	<Typography variant={ 'h4'} id="vote.vote.Text.6" >{i18next.t('vote.vote.Text.6')}</Typography>
              </Button>
  					}
  				</div>
  			</div>
  	...
  	if(filteredProposals.length === 0) {
  		return (
  			<div className={ classes.claimContainer }>
  				<Typography className={ classes.stakeTitle } variant={ 'h3'} id="vote.vote.Text.7" >{i18next.t('vote.vote.Text.7')}</Typography>
  			</div>
  		);
  	}
  			...
  			<ExpansionPanel className={ classes.expansionPanel } square key={ proposal.id+"_expand" } expanded={ expanded === proposal.id} onChange={ () => { this.handleChange(proposal.id); } }>
  				...
  				>
                      ...
                      <WarningIcon style={{ fontSize: 20, color: orange[500] }}/>
  								...
  								<Typography variant={ 'h5' } className={ classes.grey } id="vote.vote.Text.8" >{i18next.t('vote.vote.Text.8')}</Typography>
  							</div>
  							<div>
  								...
  								<Typography variant={ 'h5' } className={ classes.grey } id="vote.vote.Text.9" >{i18next.t('vote.vote.Text.9')}</Typography>
  							</div>
  						</div>
  						<div className={classes.heading}>
