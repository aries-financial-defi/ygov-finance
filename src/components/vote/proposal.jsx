//i18n => {"vote.proposal.Text.1":"Link","vote.proposal.Text.2":"Executor","vote.proposal.Text.3":"Link","vote.proposal.Text.4":"Status","vote.proposal.Text.5":"Used votes","vote.proposal.Text.6":"Available votes","vote.proposal.Text.7":"Participation weight","vote.proposal.Text.8":"Register","vote.proposal.Text.9":"Vote For","vote.proposal.Text.10":"Vote Against"}
  			...
  			<div className={ classes.assetSummary }>
  				<div className={ classes.headingName }>
  					<div className={classes.YIPheading}>
  						...
  						<Typography variant={ 'h5' } className={ classes.grey } id="vote.proposal.Text.1" >{i18next.t('vote.proposal.Text.1')}</Typography>
  					</div>
  					<div>
  						...
  						<Typography variant={ 'h5' } className={ classes.grey } id="vote.proposal.Text.2" >{i18next.t('vote.proposal.Text.2')}</Typography>
  					</div>
  				</div>
  			...
  			<div className={ classes.assetSummary }>
  				<div className={ classes.headingName }>
  					<div className={classes.YIPheading}>
  						...
  						<Typography variant={ 'h5' } className={ classes.grey } id="vote.proposal.Text.3" >{i18next.t('vote.proposal.Text.3')}</Typography>
  					</div>
  					<div>
  			...
  			<div className={ classes.assetSummary }>
                ...
                <WarningIcon style={{ fontSize: 20, color: orange[500] }}/>
  					...
  					<div>
  						...
  						<Typography variant={ 'h5' } className={ classes.grey } id="vote.proposal.Text.4" >{i18next.t('vote.proposal.Text.4')}</Typography>
  					</div>
  				</div>
  				<div className={ classes.votesHeading }>
  					<Typography variant={ 'h3' }>{ this.formatVotes(proposal.myVotes) }</Typography>
  					<Typography variant={ 'h5' } className={ classes.grey } id="vote.proposal.Text.5" >{i18next.t('vote.proposal.Text.5')}</Typography>
  				</div>
  				<div className={ classes.votesHeading }>
  					<Typography variant={ 'h3' }>{ proposal.canStillVote ? this.formatVotes(proposal.availableVotes): 0 }</Typography>
  					<Typography variant={ 'h5' } className={ classes.grey } id="vote.proposal.Text.6" >{i18next.t('vote.proposal.Text.6')}</Typography>
  				</div>
  				<div className={ classes.votesHeading }>
  					<Typography variant={ 'h3' }>{ this.formatAsPercent(proposal.myVotesRatio) }%</Typography>
  					<Typography variant={ 'h5' } className={ classes.grey } id="vote.proposal.Text.7" >{i18next.t('vote.proposal.Text.7')}</Typography>
  				</div>
  			</div>
              ...
              <div className={ classes.actionsContainer }>
              	<div className={ classes.tradeContainer }>
              		<Button
              			...
              			fullWidth
              		>
              			<Typography className={ classes.buttonText } variant={ 'h5'} color={'secondary'} id="vote.proposal.Text.8" >{i18next.t('vote.proposal.Text.8')}</Typography>
              		</Button>
              	</div>
              </div>
          	}
              ...
              <div className={ classes.actionsContainer }>
              	<div className={ classes.tradeContainer }>
              		<Button
              			...
              			fullWidth
              		>
              			<Typography className={ classes.buttonText } variant={ 'h5'} color={'secondary'} id="vote.proposal.Text.9" >{i18next.t('vote.proposal.Text.9')}</Typography>
              		</Button>
              	</div>
              	...
              	<div className={classes.tradeContainer}>
              		<Button
              			...
              			fullWidth
              		>
              			<Typography className={ classes.buttonText } variant={ 'h5'} color='secondary' id="vote.proposal.Text.10" >{i18next.t('vote.proposal.Text.10')}</Typography>
              		</Button>
              	</div>
              </div>
          	}
