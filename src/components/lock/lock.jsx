//i18n => {"lock.lock.Text.1":"This project is in beta. Use at your own risk.","lock.lock.Text.2":"Wallet","lock.lock.Text.3":"Loading your tokens ...","lock.lock.Text.4":"Lock your tokens","lock.lock.Text.5":"Lock tokens"}
  ...
  render() {
  	...
  	return (
  		<div className={ classes.root }>
  			<Typography variant={'h5'} className={ classes.disaclaimer } id="lock.lock.Text.1" >{i18next.t('lock.lock.Text.1')}</Typography>
  			<div className={ classes.intro }>
  				<Card className={ classes.addressContainer } onClick={this.overlayClicked}>
  					<Typography variant={ 'h3'} className={ classes.walletTitle } noWrap id="lock.lock.Text.2" >{i18next.t('lock.lock.Text.2')}</Typography>
          ...
          <div className={ classes.lockContainer }>
          	<Typography className={ classes.loadingTitle } variant={ 'h3'} id="lock.lock.Text.3" >{i18next.t('lock.lock.Text.3')}</Typography>
          </div>
  			}
  			{
  				yfiToken !== null &&
          <div className={ classes.lockContainer }>
          	<Typography className={ classes.lockTitle } variant={ 'h3'} id="lock.lock.Text.4" >{i18next.t('lock.lock.Text.4')}</Typography>
          	...
          	<Button
          		...
          		onClick={ () => { this.onLock(); } }
          	>
          		<Typography variant={ 'h4'} id="lock.lock.Text.5" >{i18next.t('lock.lock.Text.5')}</Typography>
          	</Button>
          </div>
  			}
