//i18n => {"versionToggle.versionToggle.Text.1":"V1","versionToggle.versionToggle.Text.2":"V2"}
  		...
  		<Tooltip title={ title } aria-label="add">
  			<ToggleButtonGroup value={value} onChange={this.handleTabChange} aria-label="version" exclusive size={ 'small' } className={ classes.versionToggleContainer }>
  				<ToggleButton value={1} aria-label="v1" color={ 'Primary' }>
  					<Typography variant={ 'h4' } id="versionToggle.versionToggle.Text.1" >{i18next.t('versionToggle.versionToggle.Text.1')}</Typography>
  				</ToggleButton>
  				<ToggleButton value={2} aria-label="v2" color={ 'Secondary' }>
  					<Typography variant={ 'h4' } id="versionToggle.versionToggle.Text.2" >{i18next.t('versionToggle.versionToggle.Text.2')}</Typography>
  				</ToggleButton>
  			</ToggleButtonGroup>
  		</Tooltip>
  	);
