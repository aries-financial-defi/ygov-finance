//i18n => {"rewardPools.rewardPools.Text.1":"This project is in beta. Use at your own risk.","rewardPools.rewardPools.Text.2":"Open"}
  ...
  render() {
  	...
  	return (
  		<div className={ classes.root }>
  			<Typography variant={'h5'} className={ classes.disaclaimer } id="rewardPools.rewardPools.Text.1" >{i18next.t('rewardPools.rewardPools.Text.1')}</Typography>
  ...
  renderRewardPool = (rewardPool) => {
  	...
  	return (<div className={ classes.rewardPoolContainer} key={ rewardPool.id } >
        ...
        Contract Address: <a href={ 'https://etherscan.io/address/'+addy } target="_blank">{ address }</a>
  		...
  		>
  			<Typography variant={ 'h4'} id="rewardPools.rewardPools.Text.2" >{i18next.t('rewardPools.rewardPools.Text.2')}</Typography>
  		</Button>
  	</div>);
  }
